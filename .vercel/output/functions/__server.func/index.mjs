...
import { a as defineLazyEventHandler, d as NodeResponse, l as toEventHandler, n as HTTPError, t as H3Core } from "./_libs/h3+rou3+srvx.mjs";
...
var _lazy_2OcUmU = defineLazyEventHandler(() => import("./_routes/api/mill_workspace.mjs"));
var _lazy_voEyDe = defineLazyEventHandler(() => import("./_routes/api/mill_workspace.zip.mjs"));
var _lazy_IO091Z = defineLazyEventHandler(() => import("./_chunks/ssr-renderer.mjs"));
var findRoute = /* @__PURE__ */ (() => {
	const $0 = {
		route: "/api/mill-workspace",
		method: "post",
		handler: _lazy_2OcUmU
	}, $1 = {
		route: "/api/mill-workspace.zip",
		method: "get",
		handler: _lazy_voEyDe
	}, $2 = {
		route: "/**",
	...
	return (m, p) => {
		if (p.charCodeAt(p.length - 1) === 47) p = p.slice(0, -1) || "/";
		if (p === "/api/mill-workspace") {
			if (m === "POST") return { data: $0 };
		} else if (p === "/api/mill-workspace.zip") {
