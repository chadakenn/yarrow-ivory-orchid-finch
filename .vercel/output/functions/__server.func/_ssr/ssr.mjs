...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-B4cPP4P3.mjs");
...
var manifest = {
	"0bfa6c90cba78e6cd4b52bf29d3264bb4eae039020e78368a3a02251228047e4": {
		functionName: "removeRemoteDeck_createServerFn_handler",
		importer: () => import("./kiosk-YCLRd6ZC.mjs")
	},
	"3bb244513fad74173ae6fea06af30d24fe5b29fecd75a0e06023d970459da166": {
		functionName: "toggleRemoteDeck_createServerFn_handler",
		importer: () => import("./kiosk-YCLRd6ZC.mjs")
	},
	"40a353c2b56330e8713d14f69817c76fc6b1d310ae41df1c028e2db231f05b44": {
		functionName: "saveRemoteDeck_createServerFn_handler",
		importer: () => import("./kiosk-YCLRd6ZC.mjs")
	},
	"72c76414a7186669e32012ed00d32065407d8803434ea7546c58c3b7e8d01cd6": {
		functionName: "fetchKiosk_createServerFn_handler",
		importer: () => import("./kiosk-YCLRd6ZC.mjs")
	},
	"896535e7cc8c39fbda5ca0491dd9fcf2520793609ccd7a9ea9cf06aad2265bcf": {
		functionName: "listRemoteDecks_createServerFn_handler",
		importer: () => import("./kiosk-YCLRd6ZC.mjs")
	},
	"c49be3cbe29504f0a3cf7c2e25665d0dbd1ae5def75a2e358da1c07014fa9b0f": {
		functionName: "saveKiosk_createServerFn_handler",
		importer: () => import("./kiosk-YCLRd6ZC.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DbzfnbCy.mjs").then((n) => n.t),
